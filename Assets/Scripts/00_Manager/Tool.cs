...
public class Tool
{
    ...
    private static void GenerateCharacterCardData()
    {
        ...
        // ===== 임시 데이터 =====
        list.characterCardDatas.Add(new CharacterCardData { id = 0, name = "그림자 속 암살자", skills = new List<int> { 1000, 1001 }, tier = CharacterTierAndCost.Boss, race = CharacterRace.Primordial, job = CharacterJob.Dealer });
        list.characterCardDatas.Add(new CharacterCardData { id = 1, name = "하얀 검사", skills = new List<int> { 1000, 1004 }, tier = CharacterTierAndCost.High, race = CharacterRace.Primordial, job = CharacterJob.Dealer });
        list.characterCardDatas.Add(new CharacterCardData { id = 2, name = "그림자 속 수호자", skills = new List<int> { 1002, 1003 }, tier = CharacterTierAndCost.Boss, race = CharacterRace.Primordial, job = CharacterJob.Tanker });
        list.characterCardDatas.Add(new CharacterCardData { id = 3, name = "어설픈 방패병", skills = new List<int> { 1002, 1003 }, tier = CharacterTierAndCost.High, race = CharacterRace.Primordial, job = CharacterJob.Tanker });
        list.characterCardDatas.Add(new CharacterCardData { id = 4, name = "최전선의 창병", skills = new List<int> { 1000, 1003 }, tier = CharacterTierAndCost.Low, race = CharacterRace.Primordial, job = CharacterJob.Tanker });
