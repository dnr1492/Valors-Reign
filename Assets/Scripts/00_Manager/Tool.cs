...
public class Tool
{
    ...
    private static void GenerateCharacterCardData()
    {
        ...
        list.characterCardDatas.Add(new CharacterCardData { id = 1, name = "하얀 검사", skills = new List<int> { 1000, 1001 }, tier = CharacterTierAndCost.High, race = CharacterRace.Primordial, job = CharacterJob.Dealer });
